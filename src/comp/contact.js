...
const Contact = () => {
    ...
    const send = async (e) => 
    {
        ...
        const send = await fetch(
            'https://react-ecommerce-contact-d87f4-default-rtdb.firebaseio.com/Message.json', option
        )
                ...
                <div className="form">
                    ...
                    <form method="POST">
                        ...
                        <div className="box">
                         ...
                         <div className="input">
                            <input type="email" placeholder="Subject" value={user.subject} name="subject"onChange={data}></input>
                         </div>
                        </div>
                        <div className="box">
                         <div className="lable">
